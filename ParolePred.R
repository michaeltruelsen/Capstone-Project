...
cat(paste("Number of 'Yes' Predictions =", length(test1i$pred)))
...
cat(paste("Number of 'Yes' Predictions =", length(test2i$pred)))
...
cat(paste("Number of 'Yes' Predictions =", length(test3i$pred)))
